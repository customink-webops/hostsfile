...
describe 'hostsfile lwrp' do
  let(:manipulator) { double('manipulator', new: nil, save!: nil) }
  let(:chef_run) { ChefSpec::ChefRunner.new(cookbook_path: ['..', 'test/fixtures/cookbooks'], step_into: ['hostsfile_entry']) }
