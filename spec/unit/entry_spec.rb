...
describe Entry do
  describe '.initialize' do
    ...
    context 'with no options' do
      ...
      it 'calls calculate_priority for @priority' do
        Entry.any_instance.should_receive(:calculate_priority).with('2.3.4.5')
  ...
  describe '#to_s' do
    context 'without a comment' do
      ...
      it 'prints without aliases' do
        expect(subject.to_s).to eq("2.3.4.5\twww.example.com")
      end
    ...
    context 'with a comment' do
      ...
      it 'prints without aliases' do
        expect(subject.to_s).to eq("2.3.4.5\twww.example.com\t# This is a comment!")
      end
